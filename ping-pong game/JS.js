    ...
    document.addEventListener('keydown',(event)=>{
      switch(event.key){
        case 'ArrowLeft':
          ...
          rod1.style.left = parseInt(rod1.style.left) - moveBy + 'px';
          rod2.style.left = parseInt(rod2.style.left) - moveBy + 'px';
          }
          break; 
        case "ArrowRight":
        if(rod1.getBoundingClientRect().right<((window.innerWidth)-16)){
          rod2.style.left = parseInt(rod2.style.left) + moveBy + 'px';
          rod1.style.left = parseInt(rod1.style.left) + moveBy + 'px';
          }  
          break;
